...
import TrafficDataControls from './trafficDataControls';
...
class TrafficFlow extends React.Component {
  ...
  showScenario = (scenario) => {
    request.get(`trafficData/scenarios/${scenario}.json`)
      ...
      <div className="vizceral-container">
        ...
        <div className="subheader">
          ...
          <div style={{ float: 'right', paddingTop: '4px' }}>
            ...
            <OptionsPanel title="Scenario"><TrafficDataControls changedCallback={this.showScenario}/></OptionsPanel>
